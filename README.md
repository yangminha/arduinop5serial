...
## Arduino 코드는 serial 9600baud로 데이터를 내보내는 게 다 입니다.
...
2. 
3. Arduino 코드를 arudni uno에 업로드합니다. 업로드가 다 되었다면 이제 p5 차례.
4. 
5. visual studio code에서 open folder를 하고 p5serial폴더를 열어줍니다.
6. 
7. live server가 안깔려있다면 깔아주시고, vs code하단의 go live 버튼을 눌러 p5.js 코드를 실행합니다.
8. 
9. connect 버튼을 누르면 serial 연결 다이알로그 화면이 뜰거에요. 연결해주면 끝!
10. 
